...
class Command(BaseCommand):
    ...
    def fetch_weather_and_uv(self):
        ...
        try:
            ...
            uv_index = round(today_forecast.get('uvi', "N/A"))
    ...
    def send_sms(self, day_temperature, min_temperature, max_temperature, uv_index, summary):
        account_sid = os.environ.get('TWILIO_ACCOUNT_SID')
        auth_token = os.environ.get('TWILIO_AUTH_TOKEN')
        client = Client(account_sid, auth_token)

        recipient_numbers = [os.environ.get('RECIPIENT_PHONE1'), os.environ.get('RECIPIENT_PHONE2')]
    ...
    def handle(self, *args, **kwargs):
        day_temperature, min_temperature, max_temperature, uv_index, summary = self.fetch_weather_and_uv()
        if all([day_temperature, min_temperature, max_temperature, uv_index, summary]):
            self.send_sms(day_temperature, min_temperature, max_temperature, uv_index, summary)
